...
public class DrawGraph implements Callable<VBox> {
    private MyCurrency currency;
    public DrawGraph(MyCurrency currency){
    ...
    public VBox call() throws Exception {
        ...
        if(this.currency!=null){
            ...
            System.out.println("before change "+min_y+", "+max_y);
            for(CurrencyModel c:currency.getHistorical()){
                ...
                System.out.println("after change "+min_y+", "+max_y);
            }
