...
public class EquipPane extends ScrollPane {
    ...
    /*private Pane getDetailsPane(){
        ...
        if(weapon!=null){
            ...
            weaponLb = new Label("Weapon: ");
            weaponimg.setImage(new Image(getClass().getClassLoader().getResource("asset/blank.png").toString()));
        }
        if(armor!=null){
            ...
            armorLb = new Label("Armor: ");
            armorimg.setImage(new Image(getClass().getClassLoader().getResource("asset/blank.png").toString()));
        }
